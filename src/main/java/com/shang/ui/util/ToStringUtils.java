...
import static com.shang.ui.util.ToStringUtils.ToStringTokenUtils.parseToken;
import static com.shang.ui.util.ToStringUtils.ToStringTokenUtils.splitToken;
...
public class ToStringUtils {
    ...
    public static void main(String[] args) {
        try {
            System.out.println(ToStringUtils.toJSONString("requestData=[BizBaseRequest(super=BaseRequest(channel=PC, apiVersion=1), postData=DeliverGoodsRequest(orderId=154046448, userEmail=v8-a@vip.163.com, deliverGoodDtoList=[DeliverGoodDTO(packageId=1, purchaseOrderItemId=151376850, logisticsCode=4311996370970, logisticsCompany=韵达快递, logisticsKey=yunda, logisticsTel=, deliveryNum=1, weekYear=null)]))]"));
